...
message.innerText =
  'This is a test message that could have been sent by the back-end server for displaying.';

const examModeProjects = document.getElementById('exam-mode-projects');
examModeProjects.innerText =
  'Exam Rank 00, Exam Rank 01, Exam Rank 02, non-existing debug exams';
...
addScreenSwitchOption('April fool', 'april-fool-form');
...
const calendarEventTemplate = document.getElementById(
  'intra-calendar-event-template'
);
for (let i = 0; i < 5; i++) {
