...
export class APFLoginScreenUI extends LoginScreenUI {
  ...
  public constructor(auth: Authenticator) {
    ...
    this._form = {
      form: document.getElementById('april-fool-form') as HTMLFormElement,
      loginInput: document.getElementById('apf-login') as HTMLInputElement,
  ...
  protected _initForm(): void {
    ...
    (this._form as UILoginElements).form.addEventListener(
      'submit',
      (event: Event) => {
  ...
  protected _enableOrDisableSubmitButton(): boolean {
    ...
    const buttonDisabled =
      form.loginInput.value.trim() === '' || form.passwordInput.value === '';
